...
<div id="article">
  <div class="tab_menu">
    <ul>
      <li class="current"><a href="{$base_url}admin/datamanager">数据模型管理 </a></li>
    </ul>
  </div>
  <div class="tab_content_wrap">
    <div class="tab_content">
      <form id="nav_set" method="post" action="{$base_url}admin/datamanager/add" name="nav_set">
        <table id="table_nav_list" class="content_list" width="100%"  cellspacing="0" >
          ...
          <tr>
            ...
            <td><a href="{$base_url}admin/datamanager/del/{$data.id}" class="act">删除</a></td>
          </tr>
          {/if} 
          ...
          <tr>
            ...
            <td><a href="{$base_url}admin/datamanager/del/{$sub.id}" class="act">删除</a></td>
          </tr>
          {/if}
          {/foreach}
