...
<link href="{$base_url}/css/sy.css" rel="stylesheet" type="text/css" />
...
<div id="article">
    ...
    <div class="tab_content">
       ...
       <!--<img src="{$base_url}changan/images/sys.jpg" style="margin-top:-13px;margin-left:-19px;">
           ...
           确认密码：<input type="password" name="password" /><br/>
                   <input type="image"  class="dlss"  src="{$base_url}changan/images/dlss.jpg" />
  ...
  <div id="login" class="auth-form">
    ...
    <div class="auth-form-body">
      <form accept-charset="UTF-8" action="{$base_url}admin/update_pass" method="post">
