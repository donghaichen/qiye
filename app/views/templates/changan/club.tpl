  ...
  <div class="dycont">
    <div class="dyleft"> <img src="{$base_url}changan/images/kftp.jpg" alt="" />
      <div class="zcdh">
        ...
        <ul id="uu">
          ...
          <li><a href="{$base_url}service-center/wszz">网上自助</a></li>
          <li><a href="{$base_url}service-center/kefu">在线客服</a></li>
          <li style="border:0px;"><a href="{$base_url}service-center/zcfw">注册服务</a></li>
	  <li style="border:0px;"><a href="{$base_url}service-center/club">客户俱乐部</a></li>
        </ul>
      </div>
    ...
    <div class="dyright">
      <div class="rposi"><span class="span1">客户俱乐部</span>
        <div class="posi">您现在的位置：<a href="{$base_url}">首页</a> > <a href="{$base_url}service-center/ourservice">服务中心</a> > <a href="{$base_url}service-center/club">客户俱乐部</a></div>
        <div class="clear"></div>
      </div>
      <div class="rnr">
