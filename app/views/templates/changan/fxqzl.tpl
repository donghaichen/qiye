  ...
  <div class="dycont">
    <div class="dyleft"> <img src="{$base_url}changan/images/kftp.jpg" alt="" />
      <div class="zcdh">
        ...
        <ul>
          <li class="on1"><a href="{$base_url}study/lcyd">理财园地</a></li>
          <li class="z"><a href="{$base_url}study/lcyd">理财知识</a></li>
          <li class="z"><a href="{$base_url}study/lcyd">案例分享</a></li>
          <li class="z"><a href="{$base_url}study/lcyd">理财问答</a></li>
          <li><a href="{$base_url}study/hyzx">行业资讯</a></li>
          <li><a href="{$base_url}study/zcfg">政策法规</a></li>
          <li style="border:0px;"><a href="{$base_url}study/fxqzl">反洗钱专栏</a></li>
        </ul>
      </div>
