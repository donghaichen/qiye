...
Route::post('admin/update_pass','AdminController@update_pass_check');
Route::post('login','HomeController@loginCheck');

Route::get('admin/login','AdminController@login');
Route::get('admin/update_pass','AdminController@update_pass');
...
/**/	
	...
	Route::get('admin/user','AdminController@showuser');
        //删除用户
        Route::get('admin/delete_show','AdminController@delete_show');
        Route::post('admin/delete_show','AdminController@delete_user');
...
//Route::get('product','HomeController@xjbd');
Route::get('login','HomeController@showLogin');
Route::get('register','HomeController@showRegister');
Route::post('register','HomeController@Register');
Route::get('read_file','HomeController@read_file');
Route::get('wjmm','HomeController@wjmm');
Route::post('czmm','HomeController@czmm');
Route::post('login','HomeController@logincheck');
Route::get('logout','HomeController@logout');

//首页登录
Route::get('inlogin','HomeController@indexLogin');
Route::post('inlogin','HomeController@indexcheck');

//取出用户信息，用户登录后
Route::get('select_user','HomeController@select_user');

//权限控制登录
//Route::get('product','HomeController@showLogin');
Route::get('product','HomeController@xptj');
...
Route::get('study/{page}','HomeController@studyPage');
Route::get('study/{page}/{id}','HomeController@studyDetails');
...
/*//公司产品
Route::get('product','HomeController@product');
Route::get('product/{page}','HomeController@productPage');
Route::get('product/{page}/{id}','HomeController@productDetails');
*/
...
//产品详情页
Route::post('product/gscpxqy','HomeController@gscpxqy');
//分页

Route::get('product/fenye','HomeController@fenye');
